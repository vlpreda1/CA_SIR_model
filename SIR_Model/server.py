...
model_params = {
    ...
    "density": UserSettableParameter("slider", "Initial density", 0.5, 0.01, 1.0, 0.01),
    ...
    "p_reinf": UserSettableParameter("slider", "Probability of reinfection", 0.05, 0.01, 1.0, 0.01),
    "p_test": UserSettableParameter("slider", "Testing rate of population", 0.05, 0.01, 1.0, 0.01),
    "spatial": UserSettableParameter("checkbox", "Spatial", value=False),}

server = ModularServer(SIR_Model, [canvas_element, cell_chart], "SIR basic model",  model_params)
